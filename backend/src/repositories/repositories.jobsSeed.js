...
const zonesList = [
    ...
    { code: 'ZONE_RIVERSIDE_SUBURB_LV5', name: 'Riverside Suburb', type: 'urban', biome: 'urban', level_gap: 5, stage: 'early', role: 'suburb', min_lv: 5, duration: 90, inf: 0.60, rad: 0.00 },
    { code: 'ZONE_BROKEN_MARKET_LV10', name: 'Broken Market District', type: 'urban', biome: 'urban', level_gap: 10, stage: 'early', role: 'market', min_lv: 10, duration: 120, inf: 1.20, rad: 0.10 },
    { code: 'ZONE_SOUTH_FACTORY_LV15', name: 'South Factory Block', type: 'urban', biome: 'urban', level_gap: 15, stage: 'mid', role: 'industrial', min_lv: 15, duration: 180, inf: 1.80, rad: 0.30 },
    { code: 'ZONE_OUTER_GREENBELT_LV15', name: 'Outer Greenbelt', type: 'forest', biome: 'forest', level_gap: 15, stage: 'mid', role: 'woodland', min_lv: 15, duration: 180, inf: 1.40, rad: 0.10 },
    { code: 'ZONE_FISHING_PIER_LV20', name: 'Abandoned Fishing Pier', type: 'coast', biome: 'coast', level_gap: 20, stage: 'mid', role: 'pier', min_lv: 20, duration: 240, inf: 1.70, rad: 0.20 },
    { code: 'ZONE_OLD_FARMLAND_LV20', name: 'Old Farmland', type: 'rural', biome: 'rural', level_gap: 20, stage: 'mid', role: 'farm', min_lv: 20, duration: 240, inf: 1.50, rad: 0.10 },
    { code: 'ZONE_EASTERN_QUARRY_LV25', name: 'Eastern Quarry Complex', type: 'rural', biome: 'rural', level_gap: 25, stage: 'mid', role: 'mine', min_lv: 25, duration: 300, inf: 2.00, rad: 0.60 },
    { code: 'ZONE_LOGISTICS_WAREHOUSE_LV25', name: 'Logistics Warehouse Zone', type: 'urban', biome: 'urban', level_gap: 25, stage: 'mid', role: 'warehouse', min_lv: 25, duration: 300, inf: 2.30, rad: 0.40 },
    { code: 'ZONE_DOWNTOWN_RUINS_LV30', name: 'Downtown Ruins', type: 'urban', biome: 'urban', level_gap: 30, stage: 'end', role: 'city_core', min_lv: 30, duration: 420, inf: 3.20, rad: 1.00 },
    { code: 'ZONE_DEEP_REDWOOD_LV30', name: 'Deep Redwood Zone', type: 'forest', biome: 'forest', level_gap: 30, stage: 'end', role: 'deep_forest', min_lv: 30, duration: 420, inf: 2.80, rad: 0.60 },
    ...
    { code: 'ZONE_SOLAR_WASTELAND_LV35', name: 'Solar Farm Wasteland', type: 'desert', biome: 'desert', level_gap: 35, stage: 'end', role: 'energy_ruins', min_lv: 35, duration: 540, inf: 2.20, rad: 1.80 },
